...
namespace mygl 
{
    ...
    void loadTextureArrayId(const std::vector<std::string>files, unsigned int &texture, int id, int width, int height, int min_filter = GL_LINEAR, int mag_filter = GL_LINEAR, int wrap = GL_REPEAT);
}